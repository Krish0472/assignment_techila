...
import 'package:applicatio01statemanagment/screens/cartscreen.dart';
              ...
              SliverToBoxAdapter(
                child: Container(padding: const EdgeInsets.all(10),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children:[
                      Text(widget.productDetail.title.toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),),
                      SizedBox(height: 10,),
                      ...
                      SizedBox(height: 35.0,
                        child: Row(
                          children: [
                            Text('\u{20B9}${widget.productDetail.price.toString()}',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
                      ExpansionTile(
                        title: const Text('Description',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18)),
                        children: [
                          SizedBox(height:50,child: Text(widget.productDetail.description.toString(),style: TextStyle(fontWeight: FontWeight.normal,fontSize: 14),))
                        ],
                      ),
                      ExpansionTile(
                        title: const Text('discountPercentage',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18)),
                        children: [
                          Align(alignment: Alignment.topLeft,child: Text(widget.productDetail.discountPercentage.toString(),style: TextStyle(fontWeight: FontWeight.normal,fontSize: 14),))
                        ],
                      ),
                      SizedBox(height: 55,),
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          context.read<CartBloc>().add(AddToCartEvent(widget.productDetail));
                          //data.addToCart(widget.productDetail);
                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(duration: Duration(seconds: 1),content: Text('Item Added To Cart successfully'),
